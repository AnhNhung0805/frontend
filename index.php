    ...
    <section class="home" id="home">
        <div class="max-width">
            <div class="home-content">
                ...
                <div class="text-3">And I'm a <span class="typing">Intern Fsoft</span></div>
                <a href="Demo/index.html">Details for video introduce</a>
            </div>
        </div>
    </section>
            ...
            <div class="serv-content">
                <div class="card">
                    <div class="box">
                        ...
                        <div class="text">
                            Design and Play Game</div>
                        <p>
                            Paint, Edit and Effect Video, Design Mind Map. Sometime I play game such as: LOL, Contra,...</p>
                    </div>
                </div>
                <div class="card">
                    <div class="box">
                        ...
                        <div class="text">
                            Travel</div>
                        <p>
                            I went to beautiful places by motorbike, would you like to see it ?  </p>
                        
                        <a href="pagetravel/pagetravel.html">Details</a>
                    </div>
                </div>
                <div class="card">
                    <div class="box">
                        ...
                        <div class="text">
                            Code For Fun</div>
                        <p>
                            I readly readly like code, but i will fell so sad if my code has many bugs =v. Easy to fix bug if i try try try try... </p>
            ...
            <div class="contact-content">
                <div class="column left">
                    <div class="text">
                        Connect with me</div>
                    <p>
                        If you want to need me or do work, please flow imformation here</p>
                    <div class="icons">
                        <div class="row">
